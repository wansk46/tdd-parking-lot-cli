...
public class SmartParkingBoy {
    ...
    public ParkingTicket park(Car car) {
        ...
        ParkingLot firstParkinglot = findMaxEmptyParkingLot();
    ...
    public ParkingLot findMaxEmptyParkingLot(){
        int maxNumberOfEmptyPosition = 0;
        ParkingLot maxEmptyParkingLot = null;
        for (ParkingLot parkingLot : parkingLots){
            if (parkingLot.getAvailableParkingPosition() > maxNumberOfEmptyPosition){
                maxNumberOfEmptyPosition = parkingLot.getAvailableParkingPosition();
